...
class TestContact(unittest.TestCase):
    ...
    def test_save_contact(self):
        ...
        self.assertEqual(len(Contact.contact_list),1)# check if the list contains one list
    ...
    def test_save_multiple_contact(self):
        ...
        test_contact = Contact("Kepha","user","0707630747","kephaokari@gmail.com") # new contact
